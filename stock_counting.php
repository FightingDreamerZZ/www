...
* This file performs stock counting related functions, this will happen when there is a annual / cycle stock counting event
* , where all parts will be reviewed, count and even re-positioned...
* Fields that are edit-able: Qty, location, photo, flag, name, PNum,
*/
